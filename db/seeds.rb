...
exercises_data = [
  {
    ...
    TEXT
    benefits: "下半身の血流を良くして、脳をリフレッシュさせましょう。"
  },
  {
    name: "踵上げ",
    category: :training,
    ...
    TEXT
    benefits: "ふくらはぎは『第2の心臓』！全身の血流が良くなります。"
  },
  {
    name: "ヒップエクステンション",
    category: :training,
    ...
    instructions: <<~TEXT,
      ...
      体が前に倒れないように注意！
    TEXT
    benefits: "座り続けるとお尻の筋肉が固まってくるので、とても効果的です。"
  },
  {
    name: "肩甲骨の運動",
    category: :training,
  ...
  },
  {
    ...
    TEXT
    benefits: "胸の硬さは『THE 猫背』の象徴です。顔のむくみがスッキリすることも。"
  },
  {
    name: "お尻のストレッチ",
    category: :stretch,
  ...
  },
  {
    ...
    TEXT
    benefits: "反対側も同様に行いましょう！全身につながる『筋膜』を伸ばしていきます。"
  },
  {
    name: "肩のストレッチ",
    category: :stretch,
  ...
  },
  {
    ...
    instructions: <<~TEXT,
      ...
      背中が丸くならないように気をつけます
    TEXT
    benefits: "左右交互に行いましょう！背骨を動かすことで自律神経にも働きかけます。"
  },
  {
    name: "背中のストレッチ",
    category: :stretch,
    ...
    instructions: <<~TEXT,
      ...
      肩を痛めないように無理せず行いましょう
    TEXT
    benefits: "デスクワークで丸まりがちな背中を伸ばしていきましょう。背骨が動くと自律神経にも良い影響があります。"
  },
  {
    name: "首のストレッチ",
    category: :stretch,
