...
| タイマーセット |
| :---: | 
| <img width=100% alt="”” 2026-06-20 16 11 52 (1)" src="https://github.com/user-attachments/assets/760fc3cd-f30c-4b16-961d-d3c55115a312" /> |
| <p align="left" style="width: 400px;">任意の時間を選択してタイマーをスタートします。Push通知だけでなく通知音も選択可能です。</p> |
<br>

| モーダル表示 |
| :---: | 
| <img width=100% src="https://github.com/user-attachments/assets/e2420974-5a6d-4a01-89fe-e8f07e0dcefa" /> |
| <p align="left" style="width: 400px;">時間になるとモーダルが表示され運動を選択します。自分で運動を決めることも可能です。</p> |
<br>

| Push通知イメージ |
| :---: | 
| <img width=100% alt="Push通知イメージ" src="https://github.com/user-attachments/assets/891eb417-ba24-452c-8a16-1cfaf0e1c901" /> |
| <p align="left" style="width: 400px;">アプリ画面が非アクティブでも通知が来るので、休憩時間を教えてくれます</p> |
<br>

| 運動画面 |
| :---: | 
| <img width=100% alt="”” 2026-06-26 17 43 23 (4) (1)" src="https://github.com/user-attachments/assets/a97cbace-dd8a-4ffb-bb18-5d14995a4a84" /> |
| <p align="left" style="width: 400px;">エビデンスに基づいた効果的な運動を解説しています。完了することで座り過ぎのダメージ（HP）が回復。</p> |
<br>

| 履歴画面 |
| :---: | 
| <img width=100% alt="”” 2026-06-26 18 01 19 (1)" src="https://github.com/user-attachments/assets/4707841d-0f4d-4a46-a72e-2bbfac29da97" /> |
| <p align="left" style="width: 400px;">運動履歴はGituhubの草を模しており継続を促します。日別・週別・月別での活動記録も確認できます。</p> |
<br>
