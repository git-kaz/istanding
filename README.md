...
| タイマーセット |
| :---: | 
| <img width="400" height="224" alt="タイマーセット" src="https://github.com/user-attachments/assets/f036e16d-c604-4cf5-9544-ef3a1c51bfcf" /> |
| <p align="left" style="width: 400px;">任意の時間を選択してタイマーをスタートします。Push通知だけでなく通知音も選択可能です。</p> |
<br>

| モーダル表示 |
| :---: | 
| <img width="400" height="251" alt="モーダル表示" src="https://github.com/user-attachments/assets/5d478514-9617-461b-9f29-5aa1f1eacd1b" /> |
| <p align="left" style="width: 400px;">時間になるとモーダルが表示され運動を選択します。自分で運動を決めることも可能です。</p> |
<br>

| Push通知イメージ |
| :---: | 
| <img width="400" height="251" alt="Push通知イメージ" src="https://github.com/user-attachments/assets/891eb417-ba24-452c-8a16-1cfaf0e1c901" /> |
| <p align="left" style="width: 400px;">アプリ画面が非アクティブでも通知が来るので、休憩時間を教えてくれます</p> |
<br>

| 運動画面 |
| :---: | 
| <img width="400" height="251" alt="運動画面" src="https://github.com/user-attachments/assets/ef20cbf4-db28-4b89-9e92-d7d9ca941afb" /> |
| <p align="left" style="width: 400px;">エビデンスに基づいた効果的な運動を解説しています。完了することで座り過ぎのダメージ（HP）が回復。</p> |
<br>

| 履歴画面 |
| :---: | 
| <img width="400" height="251" alt="履歴画面" src="https://github.com/user-attachments/assets/deabad57-4d46-4384-96c1-54bac94d2896" /> |
